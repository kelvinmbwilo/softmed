...
<head>
    <meta charset="utf-8">
    <title>SoftMed Company Limited</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="">
    <meta name="author" content="">
	<link id="callCss" rel="stylesheet" href="themes/css/bootstrap.min_1.css" type="text/css" media="screen" charset="utf-8" />
		...
		<div class="navbar">
			...
			<div class="nav-collapse">
				<ul class="nav">
					...
					<li><a href="#portfolioSection">Product</a></li>
...
<div class="row-fluid">
    <div class="span8">
		...
		SoftMed Company Limited  is one of the  
                IT&AMP;Health systems Consulting venture that  offers a comprehensive range of capabilities.  
                Established in 2009, the company provides quality service to meet the growing demands in the 
                industry.  The company has diversified business interests in IT Solution,  System Integration, 
...
<div class="container-fluid">	
		...
		<div class="thumbnail" style="margin-bottom: 20px">
			...
			<p class="text-left">
                            ...
                            operations by keeping pace with the rapid development of computer, information and medical sciences 
                            around the globe, we at <b>SoftMed</b> believe that the only way to discover the limits of the possible 
                            is to go beyond the impossible.
                        </p>
			...
			<h2>OUR GOAL</h2>
                        <p class="text-left">
                            ...
                            best practices. We manage the projects through the full life cycle, ensuring that they meet 
                            required service levels and provide headroom for future growth once they enter production.
                        </p>
